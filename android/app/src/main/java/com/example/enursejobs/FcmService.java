...
import com.example.enursejobs.ui.activity.MainActivity;

public class FcmService extends FirebaseMessagingService
{

    private static final String TAG = "FireBase FCM";
    ...
    public void onNewToken(@NonNull String token)
    {
        ...
        AppDatabase database = AppDatabase.getInstance(getApplication().getApplicationContext(),new AppExecutors());
           Futures.addCallback(
                   database.AccessTokenDao().insertAccessToken(
                           new AccessTokenEntity(0, null, "bearer", 3600, token)),
                   new FutureCallback<Long>() {
                       ...
                       public void onFailure(@NonNull Throwable t) {
                           Log.d(TAG, "FCM token not Saved: "+token+" "+ t.getMessage());
                       }
...
//    }
    ...
    public void showNotification(String title, String message)
    {
        ...
        // A customized design for the notification can be set only for Android versions 4.1 and above. Thus
