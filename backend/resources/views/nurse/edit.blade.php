            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-1 text-gray-900">
                        <h1 class="text-center font-bold">Update Nurse</h1>
                        <x-splade-form confirm :default="$nurse" method="PATCH" :action="route('nurses.update',$nurse)" class="max-w-md mx-auto p-4 bg-white rounded-md">
                            @csrf
                            <x-splade-input name="name" label="Name" max="50" required/>
                            <x-splade-input class="mt-4" type="number" name="phone" label="Phone" />
                            ...
                            <x-splade-select name="is_resigned" label="Status">
