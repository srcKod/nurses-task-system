    ...
    <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    <!-- Logo -->
                    <div class="max-w-sm shrink-0 flex items-center">
                        ...
                        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown placement="bottom-end">
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link :href="route('nurses.index')">
                                            {{ __('Show Nurses') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link modal :href="route('nurses.create')">
                                            {{ __('New Nurse') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
                            ...
                            <!-- Carings Types Dropdown -->
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown placement="bottom-end">
                                    <x-slot name="trigger">
                                        <button class="flex items-center text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                                            <div>{{ __('Carings Types') }}</div>
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link :href="route('caringtypes.index')">
                                            {{ __('Show Carings Types') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link modal :href="route('caringtypes.create')">
                                            {{ __('New Carings Type') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown placement="bottom-end">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-dropdown-link modal :href="route('patients.create')">
                                            {{ __('New Patient') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
                            ...
                            <!-- Patients Dropdown -->
                                ...
                                <div class="hidden sm:flex sm:items-center sm:ml-6">
                                    <x-dropdown placement="bottom-end">
                                        ...
                                        <x-slot name="content">
                                            <x-dropdown-link :href="route('carings.index')">
                                                {{ __('Pending Carings') }}
                                            </x-dropdown-link>
                                            <x-dropdown-link :href="route('carings.trashed')">
                                                {{ __('Finished Carings') }}
                                            </x-dropdown-link>
                                            <x-dropdown-link modal :href="route('carings.create')">
                                                {{ __('New Caring') }}
                                            </x-dropdown-link>
                                        </x-slot>
                                    </x-dropdown>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('enurse.apidocs')">
                                {{ __('API') }}
                            </x-dropdown-link>
